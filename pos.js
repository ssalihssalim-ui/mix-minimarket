...
// ✅ Bouton Retour garanti par onpointerdown
...
// ✅ Bouton Retour simple (classe pos-back-btn)
...
// ✅ Attachement du bouton Retour avec pointerdown (toujours prioritaire)
setTimeout(function() {
    var backBtn = document.querySelector('.pos-back-btn');
    if (backBtn) {
        // Supprimer tout ancien gestionnaire
        backBtn.onpointerdown = null;
        backBtn.onclick = null;
        // Attacher nouveau gestionnaire
        backBtn.onpointerdown = function(e) {
            e.preventDefault();
...
console.log('⚡ Mixmax Minimarket - POS chargé (bouton Retour OK avec pointerdown)');
