...
// ✅ Bouton Retour réparé + Produits masqués au paiement + Pleine hauteur
...
if(!isOnPOSPage() || posStep !== 1) return; // Pas de chargement de la grille en étape 2
...
// ✅ Ajout de la classe pos-container-full en étape 2 pour pleine hauteur
...
// ✅ Attache l'écouteur sur le bouton Retour
setTimeout(function() {
    var backBtn = document.getElementById('posBackBtn');
    if (backBtn) {
...
console.log('⚡ Mixmax Minimarket - POS chargé (final optimisé avec virtualisation + tri catégories par ordre + bouton Retour OK + plein écran)');
